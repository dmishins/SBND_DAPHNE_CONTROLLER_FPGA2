...
xst -ifn xst.scr
move FMRxClk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\FMRxClk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc FMRxClk_exdes.ucf FMRxClk_exdes

echo 'Running map'
map -timing -pr b FMRxClk_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm FMRxClk_exdes -w routed.ncd routed.vhd
cd ..
