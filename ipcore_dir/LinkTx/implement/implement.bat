...
xst -ifn xst.scr
move LinkTx_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\LinkTx_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc LinkTx_exdes.ucf LinkTx_exdes

echo 'Running map'
map -timing LinkTx_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm LinkTx_exdes -w routed.ncd routed.vhd
cd ..
